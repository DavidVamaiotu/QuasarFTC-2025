...
public class FConstants {
    static {
        ...
        FollowerConstants.headingPIDFCoefficients = new CustomPIDFCoefficients(4,0,0.1,0);
        ...
        FollowerConstants.drivePIDFCoefficients = new CustomFilteredPIDFCoefficients(0.0085,0,0.0002,0.6,0);
