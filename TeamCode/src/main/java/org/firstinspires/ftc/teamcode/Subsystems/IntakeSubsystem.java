...
public class IntakeSubsystem extends SubsystemBase {
    ...
    public double SLIDER_SHELLED = 0.352;
    ...
    public double GRIPPING = 0.5;

    public double NOT_GRIPPING = 0.29;

    public double PITCH_GRIP = 0.39;

    public double PITCH_IDLE = 0.75;

    public double PITCH_TRANSFER = 0.92;

    public double ARM_TRANSFER_POS = 0.8;
...
//    private final CachingServo sldServo;
    ...
    public void armToElement() {
        arm.setPosition(ARM_READY_POS-0.07);
    }
